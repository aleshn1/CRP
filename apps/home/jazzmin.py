JAZZMIN_SETTINGS = {
    ...
    "site_title": "COMUNIDADE RENASCIDOS EM PENTECOSTES",
    ...
    "site_logo": '../static/assets/img/login_login.png',

    # Logo to use for your site, must be present in static files, used for login form logo (defaults to site_logo)
    "login_logo": '../static/assets/img/login_login.png',
    ...
    "welcome_sign": "Bem-vindo ao CRP Admin",

    # Copyright on the footer
    "copyright": "Cicero Regis E Alessandro",

    # List of model admins to search from the search bar, search bar omitted if excluded
    # Is you want to use a single search field you don't need to use a list, you can use a simple string
    # "search_model": ["auth.User", "auth.Group"],

    # Field name on user model that contains avatar ImageField/URLField/Char-field or a callable that receives the user
    "user_avatar": 'None',
    ...
    "icons": {
        ...
        "members.members": "fas fa-users",
        "members.trainers": "fas fa-users",
        "members.profession": "fas fa-briefcase",
    },
